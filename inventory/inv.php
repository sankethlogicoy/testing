...
<body  onload="init();">
    ...
    <div class="container">
	<div class="row">
     <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="overflow:auto;overflow-y: hidden;">
           <center>
                <?php
	  ...
	  <!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"><p class="it-font-text">
                       <center>             <strong>Alloted By each User</strong><br><i class="fa fa-dropbox it-font" aria-hidden="true" aria-hidden="true" data-toggle="modal" data-target="#UserList"></i>
                                </p></center>
                            </div>-->
							</div>
...
-->
      <div class="modal fade" id="myModal3" role="dialog">
	   ...
	   <div class="modal fade" id="UserList" role="dialog">
         ...
         <select class="form-control"  id="username" name="username" required onchange="getAllocationName(this.value)">
            ...
            <?php
               $sql = mysqli_query($con, "SELECT first_name FROM register where flag=0");
	 ...
	 <div class="col-lg-6">
		 <button  type="submit" class="btn btn-primary">Click Here to see Graph</button>
